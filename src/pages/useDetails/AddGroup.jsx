...
const AddGroup = ({ isOpen, toggle }) => {
  ...
  return (
    <>
      <CustomModal toggle={toggle} isOpen={isOpen} title="Assign Group">
        <Formik
        ...
        >
          {({ isSubmitting }) => (
            <Form>
              <FormGroup>
                <Label for="deviceName">Group Name</Label> <span className='text-danger'>*</span>
                <Select options={deviceName}  />
