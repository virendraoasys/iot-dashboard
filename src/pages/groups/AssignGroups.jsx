...
const AssignGroups = ({ isOpen, toggle }) => {
  ...
  return (
    <>
      <CustomModal toggle={toggle} isOpen={isOpen} title="Assign Controller">
        <Formik
        ...
        >
          {({ isSubmitting }) => (
            <Form>
              <FormGroup>
                <Label for="deviceName">Group</Label>{' '}
              ...
              <FormGroup>
                <Label for="serialNumber">User Name</Label> <span className="text-danger">*</span>
                <Select options={deviceName} className="select-field" />
